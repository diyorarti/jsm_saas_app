        ...
        <section className="flex flex-col h-[70vh]">
            <section className="flex gap-8 max-sm:flex-col">
                ...
                <div className="flex flex-col gap-4 w-1/3 max-sm:w-full max-sm:flex-row">
                    ...
                    <button className="border-2 border-black rounded-lg flex flex-col gap-2 items-center py-8 max-sm:py-2 cursor-pointer w-full" onClick={toggleMicrophone} disabled={callStatus !== CallStatus.ACTIVE}>
            ...
            <section className="relative flex flex-col gap-4 w-full items-center pt-10 flex-grow overflow-hidden">
                ...
                <div className="transcript-fadepointer-events-none absolute bottom-0 left-0 right-0 h-40 max-sm:h-20 bg-gradient-to-t from-background via-background/90 to-transparent z-10" />
            </section>
        </section>
    )
}
